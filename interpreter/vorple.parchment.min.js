...
function t(c,n,a,e){if(f.acceptData(c)){var A,b,l=f.expando,h=c.nodeType,d=h?f.cache:c,g=h?c[l]:c[l]&&l;if(g&&d[g]&&(e||d[g].data)||void 0!==a||"string"!=typeof n)return g||(g=h?c[l]=X.pop()||f.guid++:l),d[g]||(d[g]=h?{}:{toJSON:f.noop}),("object"==typeof n||"function"==typeof n)&&(e?d[g]=f.extend(d[g],n):d[g].data=f.extend(d[g].data,n)),b=d[g],e||(b.data||(b.data={}),b=b.data),void 0!==a&&(b[f.camelCase(n)]=a),"string"==typeof n?(A=b[n],null==A&&(A=b[f.camelCase(n)])):A=b,A}}function s(c,n,a){if(f.acceptData(c)){var e,
A,W=c.nodeType,l=W?f.cache:c,h=W?c[f.expando]:f.expando;if(l[h]){if(n&&(e=a?l[h]:l[h].data)){f.isArray(n)?n=n.concat(f.map(n,f.camelCase)):n in e?n=[n]:(n=f.camelCase(n),n=n in e?[n]:n.split(" "));for(A=n.length;A--;)delete e[n[A]];if(a?!b(e):!f.isEmptyObject(e))return}(a||(delete l[h].data,b(l[h])))&&(W?f.cleanData([c],!0):v.deleteExpando||l!=l.window?delete l[h]:l[h]=null)}}}function w(){return!0}function E(){return!1}function z(){try{return H.activeElement}catch(c){}}function y(c){var n=nb.split("|");
c=c.createDocumentFragment();if(c.createElement)for(;n.length;)c.createElement(n.pop());return c}function J(c,n){var a,e,A=0,b=typeof c.getElementsByTagName!==ca?c.getElementsByTagName(n||"*"):typeof c.querySelectorAll!==ca?c.querySelectorAll(n||"*"):void 0;if(!b)for(b=[],a=c.childNodes||c;null!=(e=a[A]);A++)!n||f.nodeName(e,n)?b.push(e):f.merge(b,J(e,n));return void 0===n||n&&f.nodeName(c,n)?f.merge([c],b):b}function xa(c){ga.test(c.type)&&(c.defaultChecked=c.checked)}function Y(c,n){return f.nodeName(c,
"table")&&f.nodeName(11!==n.nodeType?n:n.firstChild,"tr")?c.getElementsByTagName("tbody")[0]||c.appendChild(c.ownerDocument.createElement("tbody")):c}function M(c){return c.type=(null!==f.find.attr(c,"type"))+"/"+c.type,c}function F(c){var n=yb.exec(c.type);return n?c.type=n[1]:c.removeAttribute("type"),c}function L(c,n){for(var a,e=0;null!=(a=c[e]);e++)f._data(a,"globalEval",!n||f._data(n[e],"globalEval"))}function O(c,n){if(1===n.nodeType&&f.hasData(c)){var a,e,A;e=f._data(c);var b=f._data(n,e),
...
e?("content"===a&&(b-=f.css(c,"padding"+ya[n],!0,A)),"margin"!==a&&(b-=f.css(c,"border"+ya[n]+"Width",!0,A))):(b+=f.css(c,"padding"+ya[n],!0,A),"padding"!==a&&(b+=f.css(c,"border"+ya[n]+"Width",!0,A)));return b}function Z(c,n,a){var e=!0,A="width"===n?c.offsetWidth:c.offsetHeight,b=Ia(c),l=v.boxSizing()&&"border-box"===f.css(c,"boxSizing",!1,b);if(0>=A||null==A){if(A=Pa(c,n,b),(0>A||null==A)&&(A=c.style[n]),Wa.test(A))return A;e=l&&(v.boxSizingReliable()||A===c.style[n]);A=parseFloat(A)||0}return A+
D(c,n,a||(l?"border":"content"),e,b)+"px"}function x(c,n,a,f,e){return new x.prototype.init(c,n,a,f,e)}function Q(){return setTimeout(function(){db=void 0}),db=f.now()}function ia(c,n){var a,f={height:c},e=0;for(n=n?1:0;4>e;e+=2-n)a=ya[e],f["margin"+a]=f["padding"+a]=c;return n&&(f.opacity=f.width=c),f}function ta(c,n,a){for(var f,e=(ob[n]||[]).concat(ob["*"]),b=0,l=e.length;l>b;b++)if(f=e[b].call(a,n,c))return f}function S(c,n){var a,e,A,b,l;for(a in c)if(e=f.camelCase(a),A=n[e],b=c[a],f.isArray(b)&&
...
eq:function(c){var n=this.length;c=+c+(0>c?n:0);return this.pushStack(0<=c&&n>c?[this[c]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:C,sort:X.sort,splice:X.splice};f.extend=f.fn.extend=function(){var c,n,a,e,b,l,d=arguments[0]||{},h=1,g=arguments.length,m=!1;"boolean"==typeof d&&(m=d,d=arguments[h]||{},h++);"object"==typeof d||f.isFunction(d)||(d={});for(h===g&&(d=this,h--);g>h;h++)if(null!=(b=arguments[h]))for(e in b)c=d[e],a=b[e],d!==a&&(m&&a&&(f.isPlainObject(a)||
...
return!0},isPlainObject:function(c){var n;if(!c||"object"!==f.type(c)||c.nodeType||f.isWindow(c))return!1;try{if(c.constructor&&!T.call(c,"constructor")&&!T.call(c.constructor.prototype,"isPrototypeOf"))return!1}catch(a){return!1}if(v.ownLast)for(n in c)return T.call(c,n);for(n in c);return void 0===n||T.call(c,n)},type:function(c){return null==c?c+"":"object"==typeof c||"function"==typeof c?P[R.call(c)]||"object":typeof c},globalEval:function(c){c&&f.trim(c)&&(a.execScript||function(c){a.eval.call(a,
...
f.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(c,a){P["[object "+a+"]"]=a.toLowerCase()});var Da=function(c){function a(c,n,f,e){var B,b,l,I,A;if((n?n.ownerDocument||n:w)!==S&&Z(n),n=n||S,f=f||[],!c||"string"!=typeof c)return f;if(1!==(I=n.nodeType)&&9!==I)return[];if(X&&!e){if(B=la.exec(c))if(l=B[1])if(9===I){if(b=n.getElementById(l),!b||!b.parentNode)return f;if(b.id===l)return f.push(b),f}else{if(n.ownerDocument&&(b=n.ownerDocument.getElementById(l))&&
...
l.querySelectorAll(A)),f}catch(d){}finally{B||n.removeAttribute("id")}}}var h;a:{c=c.replace(O,"$1");var W,g;b=D(c);if(!e&&1===b.length){if(h=b[0]=b[0].slice(0),2<h.length&&"ID"===(W=h[0]).type&&t.getById&&9===n.nodeType&&X&&u.relative[h[1].type]){if(n=(u.find.ID(W.matches[0].replace(ra,Ca),n)||[])[0],!n){h=f;break a}c=c.slice(h.shift().value.length)}for(I=$a.needsContext.test(c)?0:h.length;I--&&(W=h[I],!u.relative[B=W.type]);)if((g=u.find[B])&&(e=g(W.matches[0].replace(ra,Ca),Aa.test(h[0].type)&&
v(n.parentNode)||n))){if(h.splice(I,1),c=e.length&&p(h),!c){h=(fa.apply(f,e),f);break a}break}}h=(r(c,b)(e,n,!X,f,Aa.test(c)&&v(n.parentNode)||n),f)}return h}function f(){function c(n,f){return a.push(n+" ")>u.cacheLength&&delete c[a.shift()],c[n+" "]=f}var a=[];return c}function e(c){return c[z]=!0,c}function b(c){var a=S.createElement("div");try{return!!c(a)}catch(n){return!1}finally{a.parentNode&&a.parentNode.removeChild(a)}}function l(c,a){for(var n=c.split("|"),f=c.length;f--;)u.attrHandle[n[f]]=
...
!(f[e]=n[e]))})})}function v(c){return c&&typeof c.getElementsByTagName!==J&&c}function x(){}function D(c,f){var e,B,b,l,I,A,h;if(I=Qa[c+" "])return f?0:I.slice(0);I=c;A=[];for(h=u.preFilter;I;){e&&!(B=M.exec(I))||(B&&(I=I.slice(B[0].length)||I),A.push(b=[]));e=!1;(B=aa.exec(I))&&(e=B.shift(),b.push({value:e,type:B[0].replace(O," ")}),I=I.slice(e.length));for(l in u.filter)!(B=$a[l].exec(I))||h[l]&&!(B=h[l](B))||(e=B.shift(),b.push({value:e,type:l,matches:B}),I=I.slice(e.length));if(!e)break}return f?
I.length:I?a.error(c):Qa(c,A).slice(0)}function p(c){for(var a=0,n=c.length,f="";n>a;a++)f+=c[a].value;return f}function k(c,a,n){var f=a.dir,e=n&&"parentNode"===f,B=za++;return a.first?function(a,n,B){for(;a=a[f];)if(1===a.nodeType||e)return c(a,n,B)}:function(a,n,b){var l,I,A=[U,B];if(b)for(;a=a[f];){if((1===a.nodeType||e)&&c(a,n,b))return!0}else for(;a=a[f];)if(1===a.nodeType||e){if(I=a[z]||(a[z]={}),(l=I[f])&&l[0]===U&&l[1]===B)return A[2]=l[2];if(I[f]=A,A[2]=c(a,n,b))return!0}}}function G(c){return 1<
c.length?function(a,n,f){for(var e=c.length;e--;)if(!c[e](a,n,f))return!1;return!0}:c[0]}function s(c,a,n,f,e){for(var B,b=[],l=0,I=c.length,A=null!=a;I>l;l++)(B=c[l])&&(!n||n(B,f,e))&&(b.push(B),A&&a.push(l));return b}function q(c,f,B,b,l,A){return b&&!b[z]&&(b=q(b)),l&&!l[z]&&(l=q(l,A)),e(function(e,I,A,h){var d,W,g=[],na=[],m=I.length,v;if(!(v=e)){v=f||"*";for(var x=A.nodeType?[A]:A,D=[],p=0,xb=x.length;xb>p;p++)a(v,x[p],D);v=D}v=!c||!e&&f?v:s(v,g,c,A,h);x=B?l||(e?c:m||b)?[]:I:v;if(B&&B(v,x,A,
h),b)for(d=s(x,na),b(d,[],A,h),A=d.length;A--;)(W=d[A])&&(x[na[A]]=!(v[na[A]]=W));if(e){if(l||c){if(l){d=[];for(A=x.length;A--;)(W=x[A])&&d.push(v[A]=W);l(null,x=[],d,h)}for(A=x.length;A--;)(W=x[A])&&-1<(d=l?H.call(e,W):g[A])&&(e[d]=!(I[d]=W))}}else x=s(x===I?x.splice(m,x.length):x),l?l(null,I,x,h):fa.apply(I,x)})}function ka(c){var a,n,f,e=c.length,B=u.relative[c[0].type];n=B||u.relative[" "];for(var b=B?1:0,l=k(function(c){return c===a},n,!0),I=k(function(c){return-1<H.call(a,c)},n,!0),A=[function(c,
n,f){return!B&&(f||n!==ba)||((a=n).nodeType?l(c,n,f):I(c,n,f))}];e>b;b++)if(n=u.relative[c[b].type])A=[k(G(A),n)];else{if(n=u.filter[c[b].type].apply(null,c[b].matches),n[z]){for(f=++b;e>f&&!u.relative[c[f].type];f++);return q(1<b&&G(A),1<b&&p(c.slice(0,b-1).concat({value:" "===c[b-2].type?"*":""})).replace(O,"$1"),n,f>b&&ka(c.slice(b,f)),e>f&&ka(c=c.slice(f)),e>f&&p(c))}A.push(n)}return G(A)}function N(c,f){var B=0<f.length,b=0<c.length,l=function(e,l,I,A,h){var d,W,g,na=0,m="0",x=e&&[],v=[],D=ba,
p=e||b&&u.find.TAG("*",h),xb=U+=null==D?1:Math.random()||0.1,k=p.length;for(h&&(ba=l!==S&&l);m!==k&&null!=(d=p[m]);m++){if(b&&d){for(W=0;g=c[W++];)if(g(d,l,I)){A.push(d);break}h&&(U=xb)}B&&((d=!g&&d)&&na--,e&&x.push(d))}if(na+=m,B&&m!==na){for(W=0;g=f[W++];)g(x,v,l,I);if(e){if(0<na)for(;m--;)x[m]||v[m]||(v[m]=R.call(A));v=s(v)}fa.apply(A,v);h&&!e&&0<v.length&&1<na+f.length&&a.uniqueSort(A)}return h&&(U=xb,ba=D),x};return B?e(l):l}var T,t,u,Q,ia,r,ba,K,E,Z,S,C,X,y,ta,Ta,F,z="sizzle"+-new Date,w=c.document,
U=0,za=0,ea=f(),Qa=f(),Ja=f(),L=function(c,a){return c===a&&(E=!0),0},J="undefined",Na=-2147483648,P={}.hasOwnProperty,qa=[],R=qa.pop,V=qa.push,fa=qa.push,Cb=qa.slice,H=qa.indexOf||function(c){for(var a=0,n=this.length;n>a;a++)if(this[a]===c)return a;return-1},Ea="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),ua="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+Ea+")|)|)[\\x20\\t\\r\\n\\f]*\\]",
ja=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"+ua.replace(3,8)+")*)|.*)\\)|)",O=/^[\x20\t\r\n\f]+|((?:^|[^\\])(?:\\.)*)[\x20\t\r\n\f]+$/g,M=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,aa=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,lb=/=[\x20\t\r\n\f]*([^\]'"]*?)[\x20\t\r\n\f]*\]/g,Y=RegExp(ja),va=RegExp("^"+Ea+"$"),$a={ID:/^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,CLASS:/^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,TAG:RegExp("^("+"(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w",
...
"i")},ca=/^(?:input|select|textarea|button)$/i,ma=/^h\d$/i,pa=/^[^{]+\{\s*\[native \w/,la=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,Aa=/[+~]/,Ib=/'|\\/g,ra=/\\([\da-f]{1,6}[\x20\t\r\n\f]?|([\x20\t\r\n\f])|.)/ig,Ca=function(c,a,n){c="0x"+a-65536;return c!==c||n?a:0>c?String.fromCharCode(c+65536):String.fromCharCode(c>>10|55296,1023&c|56320)};try{fa.apply(qa=Cb.call(w.childNodes),w.childNodes),qa[w.childNodes.length].nodeType}catch(ha){fa={apply:qa.length?function(c,a){V.apply(c,Cb.call(a))}:function(c,a){for(var n=
c.length,f=0;c[n++]=a[f++];);c.length=n-1}}}t=a.support={};ia=a.isXML=function(c){return(c=c&&(c.ownerDocument||c).documentElement)?"HTML"!==c.nodeName:!1};Z=a.setDocument=function(c){var a,n=c?c.ownerDocument||c:w;c=n.defaultView;return n!==S&&9===n.nodeType&&n.documentElement?(S=n,C=n.documentElement,X=!ia(n),c&&c!==c.top&&(c.addEventListener?c.addEventListener("unload",function(){Z()},!1):c.attachEvent&&c.attachEvent("onunload",function(){Z()})),t.attributes=b(function(c){return c.className="i",
...
c;f=f.parentNode;)b.unshift(f);for(f=a;f=f.parentNode;)l.unshift(f);for(;b[e]===l[e];)e++;return e?d(b[e],l[e]):b[e]===w?-1:l[e]===w?1:0},n):S};a.matches=function(c,f){return a(c,null,null,f)};a.matchesSelector=function(c,f){if((c.ownerDocument||c)!==S&&Z(c),f=f.replace(lb,"='$1']"),t.matchesSelector&&X&&!(ta&&ta.test(f)||y&&y.test(f)))try{var e=Ta.call(c,f);if(e||t.disconnectedMatch||c.document&&11!==c.document.nodeType)return e}catch(B){}return 0<a(f,S,null,[c]).length};a.contains=function(c,a){return(c.ownerDocument||
c)!==S&&Z(c),F(c,a)};a.attr=function(c,a){(c.ownerDocument||c)!==S&&Z(c);var n=u.attrHandle[a.toLowerCase()],n=n&&P.call(u.attrHandle,a.toLowerCase())?n(c,a,!X):void 0;return void 0!==n?n:t.attributes||!X?c.getAttribute(a):(n=c.getAttributeNode(a))&&n.specified?n.value:null};a.error=function(c){throw Error("Syntax error, unrecognized expression: "+c);};a.uniqueSort=function(c){var a,n=[],f=0,e=0;if(E=!t.detectDuplicates,K=!t.sortStable&&c.slice(0),c.sort(L),E){for(;a=c[e++];)a===c[e]&&(f=n.push(e));
...
a.toLowerCase())},first:m(function(){return[0]}),last:m(function(c,a){return[a-1]}),eq:m(function(c,a,n){return[0>n?n+a:n]}),even:m(function(c,a){for(var n=0;a>n;n+=2)c.push(n);return c}),odd:m(function(c,a){for(var n=1;a>n;n+=2)c.push(n);return c}),lt:m(function(c,a,n){for(a=0>n?n+a:n;0<=--a;)c.push(a);return c}),gt:m(function(c,a,n){for(n=0>n?n+a:n;++n<a;)c.push(n);return c})}};u.pseudos.nth=u.pseudos.eq;for(T in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})u.pseudos[T]=h(T);for(T in{submit:!0,
reset:!0})u.pseudos[T]=g(T);x.prototype=u.filters=u.pseudos;u.setFilters=new x;r=a.compile=function(c,a){var n,f=[],e=[],B=Ja[c+" "];if(!B){a||(a=D(c));for(n=a.length;n--;)B=ka(a[n]),B[z]?f.push(B):e.push(B);B=Ja(c,N(e,f))}return B};return t.sortStable=z.split("").sort(L).join("")===z,t.detectDuplicates=!!E,Z(),t.sortDetached=b(function(c){return 1&c.compareDocumentPosition(S.createElement("div"))}),b(function(c){return c.innerHTML="<a href='#'></a>","#"===c.firstChild.getAttribute("href")})||l("type|href|height|width",
...
a,n){var f;return n?void 0:!0===c[a]?a.toLowerCase():(f=c.getAttributeNode(a))&&f.specified?f.value:null}),a}(a);f.find=Da;f.expr=Da.selectors;f.expr[":"]=f.expr.pseudos;f.unique=Da.uniqueSort;f.text=Da.getText;f.isXMLDoc=Da.isXML;f.contains=Da.contains;var U=f.expr.match.needsContext,Ea=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,ra=/^.[^:#\[\.,]*$/;f.filter=function(c,a,e){var b=a[0];return e&&(c=":not("+c+")"),1===a.length&&1===b.nodeType?f.find.matchesSelector(b,c)?[b]:[]:f.find.matches(c,f.grep(a,function(c){return 1===
c.nodeType}))};f.fn.extend({find:function(c){var a,e=[],b=this,l=b.length;if("string"!=typeof c)return this.pushStack(f(c).filter(function(){for(a=0;l>a;a++)if(f.contains(b[a],this))return!0}));for(a=0;l>a;a++)f.find(c,b[a],e);return e=this.pushStack(1<l?f.unique(e):e),e.selector=this.selector?this.selector+" "+c:c,e},filter:function(c){return this.pushStack(h(this,c||[],!1))},not:function(c){return this.pushStack(h(this,c||[],!0))},is:function(c){return!!h(this,"string"==typeof c&&U.test(c)?f(c):
...
c.nodeName+">")?d=c.cloneNode(!0):(jb.innerHTML=c.outerHTML,jb.removeChild(d=jb.firstChild)),!(v.noCloneEvent&&v.noCloneChecked||1!==c.nodeType&&11!==c.nodeType||f.isXMLDoc(c)))for(b=J(d),g=J(c),h=0;null!=(l=g[h]);++h)if(b[h]){var x=b[h],k=void 0,D=void 0,p=void 0;if(1===x.nodeType){if(k=x.nodeName.toLowerCase(),!v.noCloneEvent&&x[f.expando]){p=f._data(x);for(D in p.events)f.removeEvent(x,D,p.handle);x.removeAttribute(f.expando)}"script"===k&&x.text!==l.text?(M(x).text=l.text,F(x)):"object"===k?(x.parentNode&&
(x.outerHTML=l.outerHTML),v.html5Clone&&l.innerHTML&&!f.trim(x.innerHTML)&&(x.innerHTML=l.innerHTML)):"input"===k&&ga.test(l.type)?(x.defaultChecked=x.checked=l.checked,x.value!==l.value&&(x.value=l.value)):"option"===k?x.defaultSelected=x.selected=l.defaultSelected:("input"===k||"textarea"===k)&&(x.defaultValue=l.defaultValue)}}if(a)if(e)for(g=g||J(c),b=b||J(d),h=0;null!=(l=g[h]);h++)O(l,b[h]);else O(c,d);return b=J(d,"script"),0<b.length&&L(b,!m&&J(c,"script")),d},buildFragment:function(c,a,e,b){for(var l,
...
d.childNodes[l],"tbody")&&!x.childNodes.length&&d.removeChild(x);f.merge(G,g.childNodes);for(g.textContent="";g.firstChild;)g.removeChild(g.firstChild);g=p.lastChild}else G.push(a.createTextNode(d));g&&p.removeChild(g);v.appendChecked||f.grep(J(G,"input"),xa);for(s=0;d=G[s++];)if((!b||-1===f.inArray(d,b))&&(h=f.contains(d.ownerDocument,d),g=J(p.appendChild(d),"script"),h&&L(g),e))for(l=0;d=g[l++];)ib.test(d.type||"")&&e.push(d);return p},cleanData:function(c,a){for(var e,b,l,d,h=0,g=f.expando,m=f.cache,
x=v.deleteExpando,k=f.event.special;null!=(e=c[h]);h++)if((a||f.acceptData(e))&&(l=e[g],d=l&&m[l])){if(d.events)for(b in d.events)k[b]?f.event.remove(e,b):f.removeEvent(e,b,d.handle);m[l]&&(delete m[l],x?delete e[g]:typeof e.removeAttribute!==ca?e.removeAttribute(g):e[g]=null,X.push(l))}}});f.fn.extend({text:function(c){return Ma(this,function(c){return void 0===c?f.text(this):this.empty().append((this[0]&&this[0].ownerDocument||H).createTextNode(c))},null,c,arguments.length)},append:function(){return this.domManip(arguments,
function(c){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||Y(this,c).appendChild(c)})},prepend:function(){return this.domManip(arguments,function(c){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var a=Y(this,c);a.insertBefore(c,a.firstChild)}})},before:function(){return this.domManip(arguments,function(c){this.parentNode&&this.parentNode.insertBefore(c,this)})},after:function(){return this.domManip(arguments,function(c){this.parentNode&&this.parentNode.insertBefore(c,this.nextSibling)})},
remove:function(c,a){for(var e,b=c?f.filter(c,this):this,l=0;null!=(e=b[l]);l++)a||1!==e.nodeType||f.cleanData(J(e)),e.parentNode&&(a&&f.contains(e.ownerDocument,e)&&L(J(e,"script")),e.parentNode.removeChild(e));return this},empty:function(){for(var c,a=0;null!=(c=this[a]);a++){for(1===c.nodeType&&f.cleanData(J(c,!1));c.firstChild;)c.removeChild(c.firstChild);c.options&&f.nodeName(c,"select")&&(c.options.length=0)}return this},clone:function(c,a){return c=null==c?!1:c,a=null==a?c:a,this.map(function(){return f.clone(this,
...
this[0].ownerDocument,!1,this),e=d.firstChild,1===d.childNodes.length&&(d=e),e)){l=f.map(J(d,"script"),M);for(b=l.length;g>h;h++)e=d,h!==x&&(e=f.clone(e,!0,!0),b&&f.merge(l,J(e,"script"))),a.call(this[h],e,h);if(b)for(d=l[l.length-1].ownerDocument,f.map(l,F),h=0;b>h;h++)e=l[h],ib.test(e.type||"")&&!f._data(e,"globalEval")&&f.contains(d,e)&&(e.src?f._evalUrl&&f._evalUrl(e.src):f.globalEval((e.text||e.textContent||e.innerHTML||"").replace(ub,"")));d=e=null}return this}});f.each({appendTo:"append",prependTo:"prepend",
...
f.ajaxSettings),a):va(f.ajaxSettings,c)},ajaxPrefilter:za(Rb),ajaxTransport:za(Gb),ajax:function(c,a){function e(c,a,b,l){var n,v,t,q,ka=a;if(2!==T){T=2;g&&clearTimeout(g);x=void 0;h=l||"";N.readyState=0<c?4:0;l=200<=c&&300>c||304===c;if(b){t=k;for(var B=N,Q,ia,K,ba,A=t.contents,r=t.dataTypes;"*"===r[0];)r.shift(),void 0===ia&&(ia=t.mimeType||B.getResponseHeader("Content-Type"));if(ia)for(ba in A)if(A[ba]&&A[ba].test(ia)){r.unshift(ba);break}if(r[0]in b)K=r[0];else{for(ba in b){if(!r[0]||t.converters[ba+
" "+r[0]]){K=ba;break}Q||(Q=ba)}K=K||Q}t=K?(K!==r[0]&&r.unshift(K),b[K]):void 0}var E;a:{b=k;Q=t;ia=N;K=l;var S,Z,y;t={};B=b.dataTypes.slice();if(B[1])for(S in b.converters)t[S.toLowerCase()]=b.converters[S];for(ba=B.shift();ba;)if(b.responseFields[ba]&&(ia[b.responseFields[ba]]=Q),!y&&K&&b.dataFilter&&(Q=b.dataFilter(Q,b.dataType)),y=ba,ba=B.shift())if("*"===ba)ba=y;else if("*"!==y&&y!==ba){if(S=t[y+" "+ba]||t["* "+ba],!S)for(E in t)if(Z=E.split(" "),Z[1]===ba&&(S=t[y+" "+Z[0]]||t["* "+Z[0]])){!0===
S?S=t[E]:!0!==t[E]&&(ba=Z[0],B.unshift(Z[1]));break}if(!0!==S)if(S&&b["throws"])Q=S(Q);else try{Q=S(Q)}catch(C){E={state:"parsererror",error:S?C:"No conversion from "+y+" to "+ba};break a}}E={state:"success",data:Q}}t=E;l?(k.ifModified&&(q=N.getResponseHeader("Last-Modified"),q&&(f.lastModified[d]=q),q=N.getResponseHeader("etag"),q&&(f.etag[d]=q)),204===c||"HEAD"===k.type?ka="nocontent":304===c?ka="notmodified":(ka=t.state,n=t.data,v=t.error,l=!v)):(v=ka,(c||!ka)&&(ka="error",0>c&&(c=0)));N.status=
c;N.statusText=(a||ka)+"";l?G.resolveWith(p,[n,ka,N]):G.rejectWith(p,[N,ka,v]);N.statusCode(u);u=void 0;m&&D.trigger(l?"ajaxSuccess":"ajaxError",[N,k,l?n:v]);s.fireWith(p,[N,ka]);m&&(D.trigger("ajaxComplete",[N,k]),--f.active||f.event.trigger("ajaxStop"))}}"object"==typeof c&&(a=c,c=void 0);a=a||{};var b,l,d,h,g,m,x,v,k=f.ajaxSetup({},a),p=k.context||k,D=k.context&&(p.nodeType||p.jquery)?f(p):f.event,G=f.Deferred(),s=f.Callbacks("once memory"),u=k.statusCode||{},t={},q={},T=0,ka="canceled",N={readyState:0,
getResponseHeader:function(c){var a;if(2===T){if(!v)for(v={};a=ec.exec(h);)v[a[1].toLowerCase()]=a[2];a=v[c.toLowerCase()]}return null==a?null:a},getAllResponseHeaders:function(){return 2===T?h:null},setRequestHeader:function(c,a){var e=c.toLowerCase();return T||(c=q[e]=q[e]||c,t[c]=a),this},overrideMimeType:function(c){return T||(k.mimeType=c),this},statusCode:function(c){var a;if(c)if(2>T)for(a in c)u[a]=[u[a],c[a]];else N.always(c[N.status]);return this},abort:function(c){c=c||ka;return x&&x.abort(c),
e(0,c),this}};if(G.promise(N).complete=s.add,N.success=N.done,N.error=N.fail,k.url=((c||k.url||Ua)+"").replace(dc,"").replace(gc,ab[1]+"//"),k.type=a.method||a.type||k.method||k.type,k.dataTypes=f.trim(k.dataType||"*").toLowerCase().match(sa)||[""],null==k.crossDomain&&(b=Qb.exec(k.url.toLowerCase()),k.crossDomain=!(!b||b[1]===ab[1]&&b[2]===ab[2]&&(b[3]||("http:"===b[1]?"80":"443"))===(ab[3]||("http:"===ab[1]?"80":"443")))),k.data&&k.processData&&"string"!=typeof k.data&&(k.data=f.param(k.data,k.traditional)),
ua(Rb,k,a,N),2===T)return N;(m=k.global)&&0===f.active++&&f.event.trigger("ajaxStart");k.type=k.type.toUpperCase();k.hasContent=!fc.test(k.type);d=k.url;k.hasContent||(k.data&&(d=k.url+=(Lb.test(d)?"&":"?")+k.data,delete k.data),!1===k.cache&&(k.url=Pb.test(d)?d.replace(Pb,"$1_="+Kb++):d+(Lb.test(d)?"&":"?")+"_="+Kb++));k.ifModified&&(f.lastModified[d]&&N.setRequestHeader("If-Modified-Since",f.lastModified[d]),f.etag[d]&&N.setRequestHeader("If-None-Match",f.etag[d]));(k.data&&k.hasContent&&!1!==k.contentType||
a.contentType)&&N.setRequestHeader("Content-Type",k.contentType);N.setRequestHeader("Accept",k.dataTypes[0]&&k.accepts[k.dataTypes[0]]?k.accepts[k.dataTypes[0]]+("*"!==k.dataTypes[0]?", "+Sb+"; q=0.01":""):k.accepts["*"]);for(l in k.headers)N.setRequestHeader(l,k.headers[l]);if(k.beforeSend&&(!1===k.beforeSend.call(p,N,k)||2===T))return N.abort();ka="abort";for(l in{success:1,error:1,complete:1})N[l](k[l]);if(x=ua(Gb,k,a,N)){N.readyState=1;m&&D.trigger("ajaxSend",[N,k]);k.async&&0<k.timeout&&(g=setTimeout(function(){N.abort("timeout")},
k.timeout));try{T=1,x.send(t,e)}catch(Q){if(!(2>T))throw Q;e(-1,Q)}}else e(-1,"No Transport");return N},getJSON:function(c,a,e){return f.get(c,a,e,"json")},getScript:function(c,a){return f.get(c,void 0,a,"script")}});f.each(["get","post"],function(c,a){f[a]=function(c,e,b,l){return f.isFunction(e)&&(l=l||b,b=e,e=void 0),f.ajax({url:c,type:a,dataType:l,data:e,success:b})}});f.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(c,a){f.fn[a]=function(c){return this.on(a,
...
null)},set:function(a,d){var g=(a.nodeName||"").toLowerCase();return"button"===g?b.apply(this,arguments):("input"!==g&&"option"!==g&&h("jQuery.fn.attr('value', val) no longer sets properties"),a.value=d,k)}};var z,y,J=a.fn.init,xa=a.parseJSON,Y=/^([^<]*)(<[\w\W]+>)([^>]*)$/;a.fn.init=function(b,d,g){var k;return b&&"string"==typeof b&&!a.isPlainObject(d)&&(k=Y.exec(a.trim(b)))&&k[0]&&("<"!==b.charAt(0)&&h("$(html) HTML strings must start with '<' character"),k[3]&&h("$(html) HTML text after last tag is ignored"),
...
this.sub;b.fn.init=function(h,g){return g&&g instanceof a&&!(g instanceof b)&&(g=b(g)),a.fn.init.call(this,h,g,d)};b.fn.init.prototype=b.fn;var d=b(document);return h("jQuery.sub() is deprecated"),b};a.ajaxSetup({converters:{"text json":a.parseJSON}});var M=a.fn.data;a.fn.data=function(b){var d,g,m=this[0];return!m||"events"!==b||1!==arguments.length||(d=a.data(m,b),g=a._data(m,b),d!==k&&d!==g||g===k)?M.apply(this,arguments):(h("Use of jQuery.fn.data('events') is deprecated"),g)};var F=/\/(java|ecma)script/i,
L=a.fn.andSelf||a.fn.addBack;a.fn.andSelf=function(){return h("jQuery.fn.andSelf() replaced by jQuery.fn.addBack()"),L.apply(this,arguments)};a.clean||(a.clean=function(b,d,g,m){d=d||document;d=!d.nodeType&&d[0]||d;d=d.ownerDocument||d;h("jQuery.clean() is deprecated");var p,D,G=[];if(a.merge(G,a.buildFragment(b,d).childNodes),g)for(p=function(a){return!a.type||F.test(a.type)?m?m.push(a.parentNode?a.parentNode.removeChild(a):a):g.appendChild(a):k},b=0;null!=(d=G[b]);b++)a.nodeName(d,"script")&&p(d)||
(g.appendChild(d),d.getElementsByTagName!==k&&(D=a.grep(a.merge([],d.getElementsByTagName("script")),p),G.splice.apply(G,[b+1,0].concat(D)),b+=D.length));return G});var O=a.event.add,aa=a.event.remove,la=a.event.trigger,ma=a.fn.toggle,ha=a.fn.live,da=a.fn.die,G=/\b(?:ajaxStart|ajaxStop|ajaxSend|ajaxComplete|ajaxError|ajaxSuccess)\b/,D=/(?:^|\s)hover(\.\S+|)\b/,Z=function(b){return"string"!=typeof b||a.event.special.hover?b:(D.test(b)&&h("'hover' pseudo-event is deprecated, use 'mouseenter mouseleave'"),
b&&b.replace(D,"mouseenter$1 mouseleave$1"))};a.event.props&&"attrChange"!==a.event.props[0]&&a.event.props.unshift("attrChange","attrName","relatedNode","srcElement");a.event.dispatch&&m(a.event,"handle",a.event.dispatch,"jQuery.event.handle is undocumented and deprecated");a.event.add=function(a,b,d,g,k){a!==document&&G.test(b)&&h("AJAX events should be attached to document: "+b);O.call(this,a,Z(b||""),d,g,k)};a.event.remove=function(a,b,d,h,g){aa.call(this,a,Z(b)||"",d,h,g)};a.fn.error=function(){var a=
...
function(b){if(!b.isDefaultPrevented()&&b.target===k[0]){var d=a(L).filter("[is-modal-qtip]"),g=y.modal.zindex+d.length,h=parseInt(k[0].style.zIndex,10);q[0].style.zIndex=g-1;d.each(function(){this.style.zIndex>h&&(this.style.zIndex-=1)});d.end().filter("."+aa).qtip("blur",b.originalEvent);k.addClass(aa)[0].style.zIndex=g;try{b.preventDefault()}catch(m){}}}).bind("tooltiphide.qtipmodal",function(b){b.target===k[0]&&a("[is-modal-qtip]").filter(":visible").not(k).last().qtip("focus",b)});g.escape&&
a(window).unbind(m).bind("keydown"+m,function(a){27===a.keyCode&&k.hasClass(aa)&&b.hide(a)});g.blur&&h.overlay.unbind(m).bind("click"+m,function(a){k.hasClass(aa)&&b.hide(a)});return d},create:function(){function b(){q.css({height:a(window).height(),width:a(window).width()})}var d=a("#qtip-overlay");if(d.length)return h.overlay=d.insertAfter(a(L).last());q=h.overlay=a("<div />",{id:"qtip-overlay",html:"<div></div>",mousedown:function(){return s}}).insertAfter(a(L).last());a(window).unbind(".qtipmodal").bind("resize.qtipmodal",
b);b();return q},toggle:function(b,h,G){if(b&&b.isDefaultPrevented())return d;b=g.effect;var x=h?"show":"hide",r=q.is(":visible"),u=a("[is-modal-qtip]").filter(":visible").not(k);q||(q=d.create());if(q.is(":animated")&&r===h||!h&&u.length)return d;h?(q.css({left:0,top:0}),q.toggleClass("blurs",g.blur),p.bind("focusin"+m,function(b){var d=a(b.target).closest(".qtip");!(1>d.length?s:parseInt(d[0].style.zIndex,10)>parseInt(k[0].style.zIndex,10))&&a(b.target).closest(L)[0]!==k[0]&&k.find("input:visible").filter(":first").focus()})):
...
var p=this,q=b.options.style.tip,r=b.elements,z=r.tooltip,F={top:0,left:0},L={width:q.width,height:q.height},J,O,u=q.border||0,M=!!(a("<canvas />")[0]||{}).getContext;p.mimic=p.corner=w;p.border=u;p.offset=q.offset;p.size=L;b.checks.tip={"^position.my|style.tip.(corner|mimic|border)$":function(){p.init()||p.destroy();b.reposition()},"^style.tip.(height|width)$":function(){L={width:q.width,height:q.height};p.create();p.update();b.reposition()},"^content.title.text|style.(classes|widget)$":function(){r.tip&&
p.update()}};a.extend(p,{init:function(){var b=p.detectCorner()&&(M||a.browser.msie);b&&(p.create(),p.update(),z.unbind(".qtip-tip").bind("tooltipmove.qtip-tip",k));return b},detectCorner:function(){var a=q.corner,d=b.options.position,g=d.at,d=d.my.string?d.my.string():d.my;if(a===s||d===s&&g===s)return s;a===t?p.corner=new y.Corner(d):a.string||(p.corner=new y.Corner(a),p.corner.fixed=t);F.corner=new y.Corner(p.corner.string());return"centercenter"!==p.corner.string()},detectColours:function(d){var g,
h,k=r.tip.css("cssText","");g=d||p.corner;var m=g[g.precedance];d="border-"+m+"-color";h="border"+m.charAt(0)+m.substr(1)+"Color";var m=/rgba?\(0, 0, 0(, 0)?\)|transparent|#123456/i,D=a(document.body).css("color");b.elements.content.css("color");var s=r.titlebar&&("top"===g.y||"center"===g.y&&k.position().top+L.height/2+q.offset<r.titlebar.outerHeight(1))?r.titlebar:r.content;z.addClass(ma);J=g=k.css("background-color");O=h=k[0].style[h]||k.css(d)||z.css(d);if(!g||m.test(g))J=s.css("background-color")||
"transparent",m.test(J)&&(J=z.css("background-color")||g);if(!h||m.test(h)||h===D)O=s.css(d)||"transparent",m.test(O)&&(O=h);a("*",k).add(k).css("cssText","background-color:transparent !important;border:0 !important;");z.removeClass(ma)},create:function(){var b=L.width,d=L.height;r.tip&&r.tip.remove();r.tip=a("<div />",{"class":"ui-tooltip-tip"}).css({width:b,height:d}).prependTo(z);M?a("<canvas />").appendTo(r.tip)[0].getContext("2d").save():(r.tip.html('<vml:shape coordorigin="0,0" style="display:inline-block; position:absolute; behavior:url(#default#VML);"></vml:shape><vml:shape coordorigin="0,0" style="display:inline-block; position:absolute; behavior:url(#default#VML);"></vml:shape>'),
a("*",r.tip).bind("click mousedown",function(a){a.stopPropagation()}))},update:function(b,d){var k=r.tip,D=k.children(),G=L.width,E=L.height,z=q.mimic,T=Math.round,K,v,f,Q,fa;b||(b=F.corner||p.corner);z===s?z=b:(z=new y.Corner(z),z.precedance=b.precedance,"inherit"===z.x?z.x=b.x:"inherit"===z.y?z.y=b.y:z.x===z.y&&(z[b.precedance]=b[b.precedance]));K=z.precedance;p.detectColours(b);"transparent"!==O&&"#123456"!==O?(u=h(b,w,t),0===q.border&&0<u&&(J=O),p.border=u=q.border!==t?q.border:u):p.border=u=
0;f=m(z,G,E);p.size=fa=g(b);k.css(fa);"y"===b.precedance?Q=[T("left"===z.x?u:"right"===z.x?fa.width-G-u:(fa.width-G)/2),T("top"===z.y?fa.height-E:0)]:Q=[T("left"===z.x?fa.width-G:0),T("top"===z.y?u:"bottom"===z.y?fa.height-E-u:(fa.height-E)/2)];M?(D.attr(fa),v=D[0].getContext("2d"),v.restore(),v.save(),v.clearRect(0,0,3E3,3E3),v.translate(Q[0],Q[1]),v.beginPath(),v.moveTo(f[0][0],f[0][1]),v.lineTo(f[1][0],f[1][1]),v.lineTo(f[2][0],f[2][1]),v.closePath(),v.fillStyle=J,v.strokeStyle=O,v.lineWidth=2*
u,v.lineJoin="miter",v.miterLimit=100,u&&v.stroke(),v.fill()):(f="m"+f[0][0]+","+f[0][1]+" l"+f[1][0]+","+f[1][1]+" "+f[2][0]+","+f[2][1]+" xe",Q[2]=u&&/^(r|b)/i.test(b.string())?8===parseFloat(a.browser.version,10)?2:1:0,D.css({antialias:""+(-1<z.string().indexOf("center")),left:Q[0]-Q[2]*Number("x"===K),top:Q[1]-Q[2]*Number("y"===K),width:G+u,height:E+u}).each(function(b){var d=a(this);d[d.prop?"prop":"attr"]({coordsize:G+u+" "+(E+u),path:f,fillcolor:J,filled:!!b,stroked:!b}).css({display:u||b?
"block":"none"});!b&&""===d.html()&&d.html('<vml:stroke weight="'+2*u+'px" color="'+O+'" miterlimit="1000" joinstyle="miter"  style="behavior:url(#default#VML); display:inline-block;" />')}));d!==s&&p.position(b)},position:function(b){var d=r.tip,k={},m=Math.max(0,q.offset),D,G,E;if(q.corner===s||!d)return s;b=b||p.corner;D=b.precedance;G=g(b);E=[b.x,b.y];"x"===D&&E.reverse();a.each(E,function(d,g){var p;if("center"===g)p="y"===D?"left":"top",k[p]="50%",k["margin-"+p]=-Math.round(G["y"===D?"width":
...
(z&&(d=a("<div/>").append(d.replace(k,"")).find(z)),b.set("content.text",d))},error:function(a,d,g){!m&&0!==a.status&&b.set("content.text",d+": "+g)},context:b},h,{url:r,complete:function(){m||(E&&(b.show(g.originalEvent),q=s),a.isFunction(h.complete)&&h.complete.apply(this,arguments))}}))},destroy:function(){p&&p.abort&&p.abort();m=t}});d.init()}function g(d,g){var h,k,m,q,E,F=a(this),L=a(document.body),J=this===document?L:F;k=F.metadata?F.metadata(g.metadata):w;q="html5"===g.metadata.type&&k?k[g.metadata.name]:
w;var O=F.data(g.metadata.name||"qtipopts");try{O="string"===typeof O?(new Function("return "+O))():O}catch(M){b("Unable to parse HTML5 attribute data: "+O)}q=a.extend(t,{},z.defaults,g,"object"===typeof O?r(O):w,r(q||k));k=q.position;q.id=d;if("boolean"===typeof q.content.text)if(m=F.attr(q.content.attr),q.content.attr!==s&&m)q.content.text=m;else return b("Unable to locate content for tooltip! Aborting render of tooltip on element: ",F),s;k.container.length||(k.container=L);k.target===s&&(k.target=
J);q.show.target===s&&(q.show.target=J);q.show.solo===t&&(q.show.solo=k.container.closest("body"));q.hide.target===s&&(q.hide.target=J);q.position.viewport===t&&(q.position.viewport=k.container);k.at=new y.Corner(k.at);k.my=new y.Corner(k.my);if(a.data(this,"qtip"))if(q.overwrite)F.qtip("destroy");else if(q.overwrite===s)return s;q.suppress&&(E=a.attr(this,"title"))&&a(this).removeAttr("title").attr(ha,E);h=new p(F,q,d,!!m);a.data(this,"qtip",h);F.bind("remove.qtip-"+d+" removeqtip.qtip-"+d,function(){h.destroy()});
return h}function p(b,d,g,h){function k(){var b=[d.show.target[0],d.hide.target[0],u.rendered&&P.tooltip[0],d.position.container[0],d.position.viewport[0],window,document];u.rendered?a([]).pushStack(a.grep(b,function(a){return"object"===typeof a})).unbind(V):d.show.target.unbind(V+"-create")}function m(){function h(a){C.is(":visible")&&u.reposition(a)}function k(a){if(C.hasClass(F))return s;clearTimeout(u.timers.inactive);u.timers.inactive=setTimeout(function(){u.hide(a)},d.hide.inactive)}function p(b){if(C.hasClass(F)||
ea||ja)return s;var f=a(b.relatedTarget||b.target),g=f.closest(L)[0]===C[0],f=f[0]===r.show[0];clearTimeout(u.timers.show);clearTimeout(u.timers.hide);if("mouse"===q.target&&g||d.hide.fixed&&/mouse(out|leave|move)/.test(b.type)&&(g||f))try{b.preventDefault(),b.stopImmediatePropagation()}catch(h){}else 0<d.hide.delay?u.timers.hide=setTimeout(function(){u.hide(b)},d.hide.delay):u.hide(b)}function f(a){if(C.hasClass(F))return s;clearTimeout(u.timers.show);clearTimeout(u.timers.hide);var b=function(){u.toggle(t,
a)};0<d.show.delay?u.timers.show=setTimeout(b,d.show.delay):b()}var q=d.position,r={show:d.show.target,hide:d.hide.target,viewport:a(q.viewport),document:a(document),body:a(document.body),window:a(window)},x=a.trim(""+d.show.event).split(" "),E=a.trim(""+d.hide.event).split(" "),y=a.browser.msie&&6===parseInt(a.browser.version,10);C.bind("mouseenter"+V+" mouseleave"+V,function(a){var b="mouseenter"===a.type;b&&u.focus(a);C.toggleClass(la,b)});d.hide.fixed&&(r.hide=r.hide.add(C),C.bind("mouseover"+
V,function(){C.hasClass(F)||clearTimeout(u.timers.hide)}));/mouse(out|leave)/i.test(d.hide.event)?"window"===d.hide.leave&&r.window.bind("mouseout"+V+" blur"+V,function(a){/select|option/.test(a.target)&&!a.relatedTarget&&u.hide(a)}):/mouse(over|enter)/i.test(d.show.event)&&r.hide.bind("mouseleave"+V,function(a){clearTimeout(u.timers.show)});-1<(""+d.hide.event).indexOf("unfocus")&&q.container.closest("html").bind("mousedown"+V,function(d){var f=a(d.target);!C.hasClass(F)&&C.is(":visible");var g=
0<f.parents(L).filter(C[0]).length;f[0]===b[0]||f[0]===C[0]||g||b.has(f[0]).length||f.attr("disabled")||u.hide(d)});"number"===typeof d.hide.inactive&&(r.show.bind("qtip-"+g+"-inactive",k),a.each(z.inactiveEvents,function(a,b){r.hide.add(P.tooltip).bind(b+V+"-inactive",k)}));a.each(E,function(b,d){var g=a.inArray(d,x),h=a(r.hide);-1<g&&h.add(r.show).length===h.length||"unfocus"===d?(r.show.bind(d+V,function(a){C.is(":visible")?p(a):f(a)}),delete x[g]):r.hide.bind(d+V,p)});a.each(x,function(a,b){r.show.bind(b+
V,f)});"number"===typeof d.hide.distance&&r.show.add(C).bind("mousemove"+V,function(a){var b=R.origin||{},f=d.hide.distance,g=Math.abs;(g(a.pageX-b.pageX)>=f||g(a.pageY-b.pageY)>=f)&&u.hide(a)});"mouse"===q.target&&(r.show.bind("mousemove"+V,function(a){J={pageX:a.pageX,pageY:a.pageY,type:"mousemove"}}),q.adjust.mouse&&(d.hide.event&&(C.bind("mouseleave"+V,function(a){(a.relatedTarget||a.target)!==r.show[0]&&u.hide(a)}),P.target.bind("mouseenter"+V+" mouseleave"+V,function(a){R.onTarget="mouseenter"===
a.type})),r.document.bind("mousemove"+V,function(a){R.onTarget&&!C.hasClass(F)&&C.is(":visible")&&u.reposition(a||J)})));(q.adjust.resize||r.viewport.length)&&(a.event.special.resize?r.viewport:r.window).bind("resize"+V,h);(r.viewport.length||y&&"fixed"===C.css("position"))&&r.viewport.bind("scroll"+V,h)}function p(d,g){function h(b){function d(f){f&&(delete m[f.src],clearTimeout(u.timers.img[f.src]),a(f).unbind(V));a.isEmptyObject(m)&&(u.redraw(),g!==s&&u.reposition(R.event),b())}var k,m={};if(0===
(k=f.find("img[src]:not([height]):not([width])")).length)return d();k.each(function(b,f){if(m[f.src]===E){var g=0;(function Ka(){if(f.height||f.width||3<g)return d(f);g+=1;u.timers.img[f.src]=setTimeout(Ka,700)})();a(f).bind("error"+V+" load"+V,function(){d(this)});m[f.src]=f}})}var f=P.content;if(!u.rendered||!d)return s;a.isFunction(d)&&(d=d.call(b,R.event,u)||"");d.jquery&&0<d.length?f.empty().append(d.css({display:"block"})):f.html(d);0>u.rendered?C.queue("fx",h):(ja=0,h(a.noop));return u}function q(d,
g){var h=P.title;if(!u.rendered||!d)return s;a.isFunction(d)&&(d=d.call(b,R.event,u));if(d===s||!d&&""!==d)return ua(s);d.jquery&&0<d.length?h.empty().append(d.css({display:"block"})):h.html(d);u.redraw();g!==s&&u.rendered&&C.is(":visible")&&u.reposition(R.event)}function K(){var b=X+"-title";P.titlebar&&ua();P.titlebar=a("<div />",{"class":Y+"-titlebar "+(d.style.widget?"ui-widget-header":"")}).append(P.title=a("<div />",{id:b,"class":Y+"-title","aria-atomic":t})).insertBefore(P.content).delegate(".ui-tooltip-close",
"mousedown keydown mouseup keyup mouseout",function(b){a(this).toggleClass("ui-state-active ui-state-focus","down"===b.type.substr(-4))}).delegate(".ui-tooltip-close","mouseover mouseout",function(b){a(this).toggleClass("ui-state-hover","mouseover"===b.type)});d.content.title.button?za():u.rendered&&u.redraw()}function za(){var b=d.content.title.button,g="string"===typeof b?b:"Close tooltip";P.button&&P.button.remove();b.jquery?P.button=b:P.button=a("<a />",{"class":"ui-state-default ui-tooltip-close "+
(d.style.widget?"":Y+"-icon"),title:g,"aria-label":g}).prepend(a("<span />",{"class":"ui-icon ui-icon-close",html:"&times;"}));P.button.appendTo(P.titlebar).attr("role","button").click(function(a){C.hasClass(F)||u.hide(a);return s});u.redraw()}function ua(a){P.title&&(P.titlebar.remove(),P.titlebar=P.title=P.button=w,a!==s&&u.reposition())}function va(){var a=d.style.widget;C.toggleClass(M,a).toggleClass(O,d.style.def&&!a);P.content.toggleClass(M+"-content",a);P.titlebar&&P.titlebar.toggleClass(M+
"-header",a);P.button&&P.button.toggleClass(Y+"-icon",!a)}function pa(a){var b=0,g,f=d;for(a=a.split(".");f=f[a[b++]];)b<a.length&&(g=f);return[g||d,a.pop()]}var u=this,Sa=document.body,X=Y+"-"+g,ea=0,ja=0,C=a(),V=".qtip-"+g,P,R;u.id=g;u.rendered=s;u.elements=P={target:b};u.timers={img:{}};u.options=d;u.checks={};u.plugins={};u.cache=R={event:{},target:a(),disabled:s,attr:h,onTarget:s};u.checks.builtin={"^id$":function(b,d,g){b=g===t?z.nextid:g;d=Y+"-"+b;b!==s&&0<b.length&&!a("#"+d).length&&(C[0].id=
d,P.content[0].id=d+"-content",P.title[0].id=d+"-title")},"^content.text$":function(a,b,d){p(d)},"^content.title.text$":function(a,b,d){if(!d)return ua();!P.title&&d&&K();q(d)},"^content.title.button$":function(a,b,d){a=P.button;b=P.title;u.rendered&&(d?(b||K(),za()):a.remove())},"^position.(my|at)$":function(a,b,d){"string"===typeof d&&(a[b]=new y.Corner(d))},"^position.container$":function(a,b,d){u.rendered&&C.appendTo(d)},"^show.ready$":function(){u.rendered?u.toggle(t):u.render(1)},"^style.classes$":function(a,
b,d){C.attr("class",Y+" qtip ui-helper-reset "+d)},"^style.widget|content.title":va,"^events.(render|show|move|hide|focus|blur)$":function(b,d,g){C[(a.isFunction(g)?"":"un")+"bind"]("tooltip"+d,g)},"^(show|hide|position).(event|target|fixed|inactive|leave|distance|viewport|adjust)":function(){var a=d.position;C.attr("tracking","mouse"===a.target&&a.adjust.mouse);k();m()}};a.extend(u,{render:function(g){if(u.rendered)return u;var h=d.content.text,k=d.content.title.text,f=d.position,r=a.Event("tooltiprender");
a.attr(b[0],"aria-describedby",X);C=P.tooltip=a("<div/>",{id:X,"class":Y+" qtip ui-helper-reset "+O+" "+d.style.classes+" "+Y+"-pos-"+d.position.my.abbrev(),width:d.style.width||"",height:d.style.height||"",tracking:"mouse"===f.target&&f.adjust.mouse,role:"alert","aria-live":"polite","aria-atomic":s,"aria-describedby":X+"-content","aria-hidden":t}).toggleClass(F,R.disabled).data("qtip",u).appendTo(d.position.container).append(P.content=a("<div />",{"class":Y+"-content",id:X+"-content","aria-atomic":t}));
u.rendered=-1;ea=ja=1;k&&(K(),a.isFunction(k)||q(k,s));a.isFunction(h)||p(h,s);u.rendered=t;va();a.each(d.events,function(b,d){a.isFunction(d)&&C.bind("toggle"===b?"tooltipshow tooltiphide":"tooltip"+b,d)});a.each(y,function(){"render"===this.initialize&&this(u)});m();C.queue("fx",function(a){r.originalEvent=R.event;C.trigger(r,[u]);ea=ja=0;u.redraw();(d.show.ready||g)&&u.toggle(t,R.event,s);a()});return u},get:function(a){switch(a.toLowerCase()){case "dimensions":a={height:C.outerHeight(),width:C.outerWidth()};
...
f.test(d)||m});r(d);ea=ja=1;a.each(b,function(a,b){var d,f,g;for(d in p)for(f in p[d])if(g=RegExp(f,"i").exec(a))b.push(g),p[d][f].apply(u,b)});ea=ja=0;C.is(":visible")&&u.rendered&&(k&&u.reposition("mouse"===d.position.target?w:R.event),m&&u.redraw());return u},toggle:function(b,h,k){function f(){b?(a.browser.msie&&C[0].style.removeAttribute("filter"),C.css("overflow",""),"string"===typeof r.autofocus&&a(r.autofocus,C).focus(),y=a.Event("tooltipvisible"),y.originalEvent=h?R.event:w,C.trigger(y,[u]),
r.target.trigger("qtip-"+g+"-inactive")):C.css({display:"",visibility:"",opacity:"",left:"",top:""})}if(!u.rendered)return b?u.render(1):u;var m=b?"show":"hide",r=d[m],G=C.is(":visible"),x=!h||2>d[m].target.length||R.target[0]===h.target,E=d.position,z=d.content,y;(typeof b).search("boolean|number")&&(b=!G);if(!C.is(":animated")&&G===b&&x)return u;if(h){if(/over|enter/.test(h.type)&&/out|leave/.test(R.event.type)&&h.target===d.show.target[0]&&C.has(h.relatedTarget).length)return u;R.event=a.extend({},
h)}y=a.Event("tooltip"+m);y.originalEvent=h?R.event:w;C.trigger(y,[u,90]);if(y.isDefaultPrevented())return u;a.attr(C[0],"aria-hidden",!b);b?(R.origin=a.extend({},J),u.focus(h),a.isFunction(z.text)&&p(z.text,s),a.isFunction(z.title.text)&&q(z.title.text,s),!da&&"mouse"===E.target&&E.adjust.mouse&&(a(document).bind("mousemove.qtip",function(a){J={pageX:a.pageX,pageY:a.pageY,type:"mousemove"}}),da=t),u.reposition(h,k),(y.solo=!!r.solo)&&a(L,r.solo).not(C).qtip("hide",y)):(clearTimeout(u.timers.show),
delete R.origin,da&&!a(L+'[tracking="true"]:visible',r.solo).not(C).length&&(a(document).unbind("mousemove.qtip"),da=s),u.blur(h));x&&C.stop(0,1);r.effect===s?(C[m](),f.call(C)):a.isFunction(r.effect)?(r.effect.call(C,u),C.queue("fx",function(a){f();a()})):C.fadeTo(90,b?1:0,f);b&&r.target.trigger("qtip-"+g+"-inactive");return u},show:function(a){return u.toggle(t,a)},hide:function(a){return u.toggle(s,a)},focus:function(b){if(!u.rendered)return u;var d=a(L),g=parseInt(C[0].style.zIndex,10),f=z.zindex+
...
k=f.my,m=f.at,p=f.adjust,q=p.method.split(" "),r=C.outerWidth(),t=C.outerHeight(),G=0,x=0,E=a.Event("tooltipmove"),z="fixed"===C.css("position"),F=f.viewport,w={left:0,top:0},L=f.container,Z=s,K=u.plugins.tip,O={horizontal:q[0],vertical:q[1]=q[1]||q[0],enabled:F.jquery&&h[0]!==window&&h[0]!==Sa&&"none"!==p.method,left:function(a){var b="shift"===O.horizontal,d=-L.offset.left+F.offset.left+F.scrollLeft,f="left"===k.x?r:"right"===k.x?-r:-r/2,g="left"===m.x?G:"right"===m.x?-G:-G/2,h=K&&K.size?K.size.width||
0:0,q=K&&K.corner&&"x"===K.corner.precedance&&!b?h:0,s=d-a+q,t=a+r-F.width-d+q,g=f-("x"===k.precedance||k.x===k.y?g:0)-("center"===m.x?G/2:0),v="center"===k.x;b?(q=K&&K.corner&&"y"===K.corner.precedance?h:0,g=("left"===k.x?1:-1)*f-q,w.left+=0<s?s:0<t?-t:0,w.left=Math.max(-L.offset.left+F.offset.left+(q&&"center"===K.corner.x?K.offset:0),a-g,Math.min(Math.max(-L.offset.left+F.offset.left+F.width,a+g),w.left))):(0<s&&("left"!==k.x||0<t)?w.left-=g:0<t&&("right"!==k.x||0<s)&&(w.left-=v?-g:g),w.left!==
a&&v&&(w.left-=p.x),w.left<d&&-w.left>t&&(w.left=a));return w.left-a},top:function(a){var b="shift"===O.vertical,d=-L.offset.top+F.offset.top+F.scrollTop,f="top"===k.y?t:"bottom"===k.y?-t:-t/2,g="top"===m.y?x:"bottom"===m.y?-x:-x/2,h=K&&K.size?K.size.height||0:0,q=K&&K.corner&&"y"===K.corner.precedance&&!b?h:0,r=d-a+q,d=a+t-F.height-d+q,g=f-("y"===k.precedance||k.x===k.y?g:0)-("center"===m.y?x/2:0),s="center"===k.y;b?(q=K&&K.corner&&"x"===K.corner.precedance?h:0,g=("top"===k.y?1:-1)*f-q,w.top+=0<
r?r:0<d?-d:0,w.top=Math.max(-L.offset.top+F.offset.top+(q&&"center"===K.corner.x?K.offset:0),a-g,Math.min(Math.max(-L.offset.top+F.offset.top+F.height,a+g),w.top))):(0<r&&("top"!==k.y||0<d)?w.top-=g:0<d&&("bottom"!==k.y||0<r)&&(w.top-=s?-g:g),w.top!==a&&s&&(w.top-=p.y),0>w.top&&-w.top>d&&(w.top=a));return w.top-a}};if(a.isArray(h)&&2===h.length)m={x:"left",y:"top"},w={left:h[0],top:h[1]};else if("mouse"===h&&(b&&b.pageX||R.event.pageX))m={x:"left",y:"top"},b=(!b||"resize"!==b.type&&"scroll"!==b.type?
b&&b.pageX&&"mousemove"===b.type?b:!J||!J.pageX||!p.mouse&&b&&b.pageX?!p.mouse&&R.origin&&R.origin.pageX&&d.show.distance?R.origin:b:{pageX:J.pageX,pageY:J.pageY}:R.event)||b||R.event||J||{},w={top:b.pageY,left:b.pageX};else{"event"===h?b&&b.target&&"scroll"!==b.type&&"resize"!==b.type?h=R.target=a(b.target):h=R.target:h=R.target=a(h.jquery?h:P.target);h=a(h).eq(0);if(0===h.length)return u;h[0]===document||h[0]===window?(G=y.iOS?window.innerWidth:h.width(),x=y.iOS?window.innerHeight:h.height(),h[0]===
window&&(w={top:(F||h).scrollTop(),left:(F||h).scrollLeft()})):h.is("area")&&y.imagemap?w=y.imagemap(h,m,O.enabled?q:s):"http://www.w3.org/2000/svg"===h[0].namespaceURI&&y.svg?w=y.svg(h,m):(G=h.outerWidth(),x=h.outerHeight(),w=y.offset(h,L));w.offset&&(G=w.width,x=w.height,Z=w.flipoffset,w=w.offset);if(4.1>y.iOS&&3.1<y.iOS||4.3==y.iOS||!y.iOS&&z)q=a(window),w.left-=q.scrollLeft(),w.top-=q.scrollTop();w.left+="right"===m.x?G:"center"===m.x?G/2:0;w.top+="bottom"===m.y?x:"center"===m.y?x/2:0}w.left+=
p.x+("right"===k.x?-r:"center"===k.x?-r/2:0);w.top+=p.y+("bottom"===k.y?-t:"center"===k.y?-t/2:0);O.enabled?(F={elem:F,height:F[(F[0]===window?"h":"outerH")+"eight"](),width:F[(F[0]===window?"w":"outerW")+"idth"](),scrollLeft:z?0:F.scrollLeft(),scrollTop:z?0:F.scrollTop(),offset:F.offset()||{left:0,top:0}},L={elem:L,scrollLeft:L.scrollLeft(),scrollTop:L.scrollTop(),offset:L.offset()||{left:0,top:0}},w.adjusted={left:"none"!==O.horizontal?O.left(w.left):0,top:"none"!==O.vertical?O.top(w.top):0},w.adjusted.left+
w.adjusted.top&&C.attr("class",C[0].className.replace(/ui-tooltip-pos-\w+/i,Y+"-pos-"+k.abbrev())),Z&&w.adjusted.left&&(w.left+=Z.left),Z&&w.adjusted.top&&(w.top+=Z.top)):w.adjusted={left:0,top:0};E.originalEvent=a.extend({},b);C.trigger(E,[u,w,F.elem||F]);if(E.isDefaultPrevented())return u;delete w.adjusted;g===s||isNaN(w.left)||isNaN(w.top)||"mouse"===h||!a.isFunction(f.effect)?C.css(w):a.isFunction(f.effect)&&(f.effect.call(C,u,a.extend({},w)),C.queue(function(b){a(this).css({opacity:"",height:""});
...
h),f):g,C.css("width",Math.round(g)).removeClass(ma));ja=0;return u},disable:function(b){"boolean"!==typeof b&&(b=!C.hasClass(F)&&!R.disabled);u.rendered?(C.toggleClass(F,b),a.attr(C[0],"aria-disabled",b)):R.disabled=!!b;return u},enable:function(){return u.disable(s)},destroy:function(){var h=b[0],m=a.attr(h,ha),p=b.data("qtip");u.rendered&&(C.stop(1,0).remove(),a.each(u.plugins,function(){this.destroy&&this.destroy()}));clearTimeout(u.timers.show);clearTimeout(u.timers.hide);k();p&&u!==p||(a.removeData(h,
...
eqData:!1,movieStar:!1};this.sandbox={};this.html5={usingFlash:null};this.flash={};this.ignoreFlash=this.html5Only=!1;var r,b=this,t=null,s=null,w,E=navigator.userAgent,z=a.location.href.toString(),y=document,J,xa,Y,M,F=[],L=!1,O=!1,aa=!1,la=!1,ma=!1,ha,da,G,D,Z,x,Q,ia,ta,S,K,za,ua,va,pa,u,Sa,X,ea,ja,C,V,P,R,T,Qa,v=null,f=null,Ja,fa,Aa,eb,Da,U,Ea=!1,ra=!1,Ka,H,Ab,qa=0,Xa=null,sa,mb=[],La,ca=null,pb,bb,Va,wa,ya,Oa,Ma,ga,qb=Array.prototype.slice,Ba=!1,rb,Fa,fb,nb,Ga,Ya,gb=0,Za=E.match(/(ipad|iphone|ipod)/i),
...
Ia="mpeg4 aac flv mov mp4 m4v f4v m4a m4b mp4v 3gp 3g2".split(" "),Pa=RegExp("\\.("+Ia.join("|")+")(\\?.*)?$","i");this.mimePattern=/^\s*audio\/(?:x-)?(?:mp(?:eg|3))\s*(?:$|;)/i;this.useAltURL=!cb;var wb;try{wb=Audio!==d&&(tb&&opera!==d&&10>opera.version()?new Audio(null):new Audio).canPlayType!==d}catch(Bb){wb=!1}this.hasHTML5=wb;this.setup=function(a){var f=!b.url;a!==d&&aa&&ca&&b.ok();G(a);a&&(f&&X&&a.url!==d&&b.beginDelayedInit(),!X&&a.url!==d&&"complete"===y.readyState&&setTimeout(u,1));return b};
this.supported=this.ok=function(){return ca?aa&&!la:b.useHTML5Audio&&b.hasHTML5};this.getMovie=function(b){return w(b)||y[b]||a[b]};this.createSound=function(a,f){function h(){e=eb(e);b.sounds[e.id]=new r(e);b.soundIDs.push(e.id);return b.sounds[e.id]}var e,g=null;if(!aa||!b.ok())return!1;f!==d&&(a={id:a,url:f});e=da(a);e.url=sa(e.url);void 0===e.id&&(e.id=b.setupOptions.idPrefix+gb++);if(U(e.id,!0))return b.sounds[e.id];if(bb(e))g=h(),g._setup_html5(e);else{if(b.html5Only||b.html5.usingFlash&&e.url&&
e.url.match(/data\:/i))return h();8<M&&null===e.isMovieStar&&(e.isMovieStar=!!(e.serverURL||e.type&&e.type.match(Wa)||e.url&&e.url.match(Pa)));e=Da(e,void 0);g=h();8===M?s._createSound(e.id,e.loops||1,e.usePolicyFile):(s._createSound(e.id,e.url,e.usePeakData,e.useWaveformData,e.useEQData,e.isMovieStar,e.isMovieStar?e.bufferTime:!1,e.loops||1,e.serverURL,e.duration||null,e.autoPlay,!0,e.autoLoad,e.usePolicyFile),e.serverURL||(g.connected=!0,e.onconnect&&e.onconnect.apply(g)));!e.serverURL&&(e.autoLoad||
e.autoPlay)&&g.load(e)}!e.serverURL&&e.autoPlay&&g.play();return g};this.destroySound=function(a,d){if(!U(a))return!1;var f=b.sounds[a],e;f._iO={};f.stop();f.unload();for(e=0;e<b.soundIDs.length;e++)if(b.soundIDs[e]===a){b.soundIDs.splice(e,1);break}d||f.destruct(!0);delete b.sounds[a];return!0};this.load=function(a,d){return U(a)?b.sounds[a].load(d):!1};this.unload=function(a){return U(a)?b.sounds[a].unload():!1};this.onposition=this.onPosition=function(a,d,f,e){return U(a)?b.sounds[a].onposition(d,
f,e):!1};this.clearOnPosition=function(a,d,f){return U(a)?b.sounds[a].clearOnPosition(d,f):!1};this.start=this.play=function(a,d){var f=null,e=d&&!(d instanceof Object);if(!aa||!b.ok())return!1;if(U(a,e))e&&(d={url:d});else{if(!e)return!1;e&&(d={url:d});d&&d.url&&(d.id=a,f=b.createSound(d).play())}null===f&&(f=b.sounds[a].play(d));return f};this.setPosition=function(a,d){return U(a)?b.sounds[a].setPosition(d):!1};this.stop=function(a){return U(a)?b.sounds[a].stop():!1};this.stopAll=function(){for(var a in b.sounds)b.sounds.hasOwnProperty(a)&&
b.sounds[a].stop()};this.pause=function(a){return U(a)?b.sounds[a].pause():!1};this.pauseAll=function(){var a;for(a=b.soundIDs.length-1;0<=a;a--)b.sounds[b.soundIDs[a]].pause()};this.resume=function(a){return U(a)?b.sounds[a].resume():!1};this.resumeAll=function(){var a;for(a=b.soundIDs.length-1;0<=a;a--)b.sounds[b.soundIDs[a]].resume()};this.togglePause=function(a){return U(a)?b.sounds[a].togglePause():!1};this.setPan=function(a,d){return U(a)?b.sounds[a].setPan(d):!1};this.setVolume=function(a,
d){return U(a)?b.sounds[a].setVolume(d):!1};this.mute=function(a){var d=0;a instanceof String&&(a=null);if(a)return U(a)?b.sounds[a].mute():!1;for(d=b.soundIDs.length-1;0<=d;d--)b.sounds[b.soundIDs[d]].mute();return b.muted=!0};this.muteAll=function(){b.mute()};this.unmute=function(a){a instanceof String&&(a=null);if(a)return U(a)?b.sounds[a].unmute():!1;for(a=b.soundIDs.length-1;0<=a;a--)b.sounds[b.soundIDs[a]].unmute();b.muted=!1;return!0};this.unmuteAll=function(){b.unmute()};this.toggleMute=function(a){return U(a)?
b.sounds[a].toggleMute():!1};this.getMemoryUse=function(){var a=0;s&&8!==M&&(a=parseInt(s._getMemoryUse(),10));return a};this.disable=function(f){var h;f===d&&(f=!1);if(la)return!1;la=!0;for(h=b.soundIDs.length-1;0<=h;h--)R(b.sounds[b.soundIDs[h]]);ha(f);ga.remove(a,"load",Q);return!0};this.canPlayMIME=function(a){var d;b.hasHTML5&&(d=Va({type:a}));!d&&ca&&(d=a&&b.ok()?!!(8<M&&a.match(Wa)||a.match(b.mimePattern)):null);return d};this.canPlayURL=function(a){var d;b.hasHTML5&&(d=Va({url:a}));!d&&ca&&
(d=a&&b.ok()?!!a.match(b.filePattern):null);return d};this.canPlayLink=function(a){return a.type!==d&&a.type&&b.canPlayMIME(a.type)?!0:b.canPlayURL(a.href)};this.getSoundById=function(a,d){return a?b.sounds[a]:null};this.onready=function(b,d){if("function"===typeof b)d||(d=a),Z("onready",b,d),x();else throw Ja("needFunction","onready");return!0};this.ontimeout=function(b,d){if("function"===typeof b)d||(d=a),Z("ontimeout",b,d),x({type:"ontimeout"});else throw Ja("needFunction","ontimeout");return!0};
this._wD=this._writeDebug=function(a,b){return!0};this._debug=function(){};this.reboot=function(d,h){var g,e,k;for(g=b.soundIDs.length-1;0<=g;g--)b.sounds[b.soundIDs[g]].destruct();if(s)try{Ha&&(f=s.innerHTML),v=s.parentNode.removeChild(s)}catch(m){}f=v=ca=s=null;b.enabled=X=aa=Ea=ra=L=O=la=Ba=b.swfLoaded=!1;b.soundIDs=[];b.sounds={};gb=0;if(d)F=[];else for(g in F)if(F.hasOwnProperty(g))for(e=0,k=F[g].length;e<k;e++)F[g][e].fired=!1;b.html5={usingFlash:null};b.flash={};b.html5Only=!1;b.ignoreFlash=
...
fatal:!0})}}e.url=l.url;return e};this.unload=function(){0!==e.readyState&&(e.isHTML5?(p(),e._a&&(e._a.pause(),y=ya(e._a))):8===M?s._unload(e.id,"about:blank"):s._unload(e.id),h());return e};this.destruct=function(a){e.isHTML5?(p(),e._a&&(e._a.pause(),ya(e._a),Ba||m(),e._a._s=null,e._a=null)):(e._iO.onfailure=null,s._destroySound(e.id));a||b.destroySound(e.id,!0)};this.start=this.play=function(a,f){var l,g,h,k,m;g=!0;g=null;f=f===d?!0:f;a||(a={});e.url&&(e._iO.url=e.url);e._iO=da(e._iO,e.options);
e._iO=da(a,e._iO);e._iO.url=sa(e._iO.url);e.instanceOptions=e._iO;if(!e.isHTML5&&e._iO.serverURL&&!e.connected)return e.getAutoPlay()||e.setAutoPlay(!0),e;bb(e._iO)&&(e._setup_html5(e._iO),q());1===e.playState&&!e.paused&&(l=e._iO.multiShot,l||(e.isHTML5&&e.setPosition(e._iO.position),g=e));if(null!==g)return g;a.url&&a.url!==e.url&&(e.readyState||e.isHTML5||8!==M||!F?e.load(e._iO):F=!1);e.loaded||(0===e.readyState?(e.isHTML5||b.html5Only?e.isHTML5?e.load(e._iO):g=e:(e._iO.autoPlay=!0,e.load(e._iO)),
e.instanceOptions=e._iO):2===e.readyState&&(g=e));if(null!==g)return g;!e.isHTML5&&9===M&&(0<e.position&&e.position===e.duration)&&(a.position=0);if(e.paused&&0<=e.position&&(!e._iO.serverURL||0<e.position))e.resume();else{e._iO=da(a,e._iO);if(null!==e._iO.from&&null!==e._iO.to&&0===e.instanceCount&&0===e.playState&&!e._iO.serverURL){l=function(){e._iO=da(a,e._iO);e.play(e._iO)};e.isHTML5&&!e._html5_canplay?(e.load({_oncanplay:l}),g=!1):e.isHTML5||(e.loaded||e.readyState&&2===e.readyState)||(e.load({onload:l}),
g=!1);if(null!==g)return g;e._iO=z()}(!e.instanceCount||e._iO.multiShotEvents||e.isHTML5&&e._iO.multiShot&&!Ba||!e.isHTML5&&8<M&&!e.getAutoPlay())&&e.instanceCount++;e._iO.onposition&&0===e.playState&&r(e);e.playState=1;e.paused=!1;e.position=e._iO.position===d||isNaN(e._iO.position)?0:e._iO.position;e.isHTML5||(e._iO=Da(eb(e._iO)));e._iO.onplay&&f&&(e._iO.onplay.apply(e),v=!0);e.setVolume(e._iO.volume,!0);e.setPan(e._iO.pan,!0);e.isHTML5?2>e.instanceCount?(q(),g=e._setup_html5(),e.setPosition(e._iO.position),
g.play()):(h=new Audio(e._iO.url),k=function(){ga.remove(h,"ended",k);e._onfinish(e);ya(h);h=null},m=function(){ga.remove(h,"canplay",m);try{h.currentTime=e._iO.position/1E3}catch(a){}h.play()},ga.add(h,"ended",k),void 0!==e._iO.volume&&(h.volume=Math.max(0,Math.min(1,e._iO.volume/100))),e.muted&&(h.muted=!0),e._iO.position?ga.add(h,"canplay",m):h.play()):(g=s._start(e.id,e._iO.loops||1,9===M?e.position:e.position/1E3,e._iO.multiShot||!1),9===M&&!g&&e._iO.onplayerror&&e._iO.onplayerror.apply(e))}return e};
...
e.instanceCount++)};this.getAutoPlay=function(){return e._iO.autoPlay};this.setPosition=function(a){a===d&&(a=0);var b=e.isHTML5?Math.max(a,0):Math.min(e.duration||e._iO.duration,Math.max(a,0));e.position=b;a=e.position/1E3;e._resetOnPosition(e.position);e._iO.position=b;if(e.isHTML5){if(e._a){if(e._html5_canplay){if(e._a.currentTime!==a)try{e._a.currentTime=a,(0===e.playState||e.paused)&&e._a.pause()}catch(f){}}else if(a)return e;e.paused&&e._onTimer(!0)}}else a=9===M?e.position:a,e.readyState&&
...
a.multiShot));!v&&a.onplay?(a.onplay.apply(e),v=!0):a.onresume&&a.onresume.apply(e);return e};this.togglePause=function(){if(0===e.playState)return e.play({position:9!==M||e.isHTML5?e.position/1E3:e.position}),e;e.paused?e.resume():e.pause();return e};this.setPan=function(a,b){a===d&&(a=0);b===d&&(b=!1);e.isHTML5||s._setPan(e.id,a);e._iO.pan=a;b||(e.pan=a,e.options.pan=a);return e};this.setVolume=function(a,f){a===d&&(a=100);f===d&&(f=!1);e.isHTML5?e._a&&(b.muted&&!e.muted&&(e.muted=!0,e._a.muted=
...
e.duration:l.duration?e.duration>l.duration?e.duration:l.duration:parseInt(e.bytesTotal/e.bytesLoaded*e.duration,10);e.isHTML5||(e.buffered=[{start:0,end:e.duration}]);(3!==e.readyState||e.isHTML5)&&l.whileloading&&l.whileloading.apply(e)};this._whileplaying=function(a,b,f,l,g){var h=e._iO;if(isNaN(a)||null===a)return!1;e.position=Math.max(0,a);e._processOnPosition();!e.isHTML5&&8<M&&(h.usePeakData&&b!==d&&b&&(e.peakData={left:b.leftPeak,right:b.rightPeak}),h.useWaveformData&&f!==d&&f&&(e.waveformData=
{left:f.split(","),right:l.split(",")}),h.useEQData&&g!==d&&(g&&g.leftEQ)&&(a=g.leftEQ.split(","),e.eqData=a,e.eqData.left=a,g.rightEQ!==d&&g.rightEQ&&(e.eqData.right=g.rightEQ.split(","))));1===e.playState&&(!e.isHTML5&&8===M&&(!e.position&&e.isBuffering)&&e._onbufferchange(0),h.whileplaying&&h.whileplaying.apply(e));return!0};this._oncaptiondata=function(a){e.captiondata=a;e._iO.oncaptiondata&&e._iO.oncaptiondata.apply(e,[a])};this._onmetadata=function(a,b){var d={},f,l;f=0;for(l=a.length;f<l;f++)d[a[f]]=
b[f];e.metadata=d;e._iO.onmetadata&&e._iO.onmetadata.apply(e)};this._onid3=function(a,b){var d=[],f,l;f=0;for(l=a.length;f<l;f++)d[a[f]]=b[f];e.id3=da(e.id3,d);e._iO.onid3&&e._iO.onid3.apply(e)};this._onconnect=function(a){a=1===a;if(e.connected=a)e.failures=0,U(e.id)&&(e.getAutoPlay()?e.play(d,e.getAutoPlay()):e._iO.autoLoad&&e.load()),e._iO.onconnect&&e._iO.onconnect.apply(e,[a])};this._ondataerror=function(a){0<e.playState&&e._iO.ondataerror&&e._iO.ondataerror.apply(e)}};ea=function(){return y.body||
y.getElementsByTagName("div")[0]};w=function(a){return y.getElementById(a)};da=function(a,f){var g=a||{},e,h;e=f===d?b.defaultOptions:f;for(h in e)e.hasOwnProperty(h)&&g[h]===d&&(g[h]="object"!==typeof e[h]||null===e[h]?e[h]:da(g[h],e[h]));return g};Ya=function(b,d){b.isHTML5||8!==M?d():a.setTimeout(d,0)};D={onready:1,ontimeout:1,defaultOptions:1,flash9Options:1,movieStarOptions:1};G=function(a,f){var g,e=!0,h=f!==d,k=b.setupOptions;for(g in a)if(a.hasOwnProperty(g))if("object"!==typeof a[g]||null===
...
M&&1<a.loops&&a.stream&&(a.stream=!1);return a};Da=function(a,b){a&&(!a.usePolicyFile&&(a.onid3||a.usePeakData||a.useWaveformData||a.useEQData))&&(a.usePolicyFile=!0);return a};J=function(){return!1};R=function(a){for(var b in a)a.hasOwnProperty(b)&&"function"===typeof a[b]&&(a[b]=J)};T=function(a){a===d&&(a=!1);(la||a)&&b.disable(a)};Qa=function(a){if(a)if(a.match(/\.swf(\?.*)?$/i)){if(a.substr(a.toLowerCase().lastIndexOf(".swf?")+4))return a}else a.lastIndexOf("/")!==a.length-1&&(a+="/");a=(a&&
-1!==a.lastIndexOf("/")?a.substr(0,a.lastIndexOf("/")+1):"./")+b.movieURL;b.noSWFCache&&(a+="?ts="+(new Date).getTime());return a};K=function(){M=parseInt(b.flashVersion,10);8!==M&&9!==M&&(b.flashVersion=M=8);var a=b.debugMode||b.debugFlash?"_debug.swf":".swf";b.useHTML5Audio&&!b.html5Only&&(b.audioFormats.mp4.required&&9>M)&&(b.flashVersion=M=9);b.version=b.versionNumber+(b.html5Only?" (HTML5-only mode)":9===M?" (AS3/Flash 9)":" (AS2/Flash 8)");8<M?(b.defaultOptions=da(b.defaultOptions,b.flash9Options),
b.features.buffering=!0,b.defaultOptions=da(b.defaultOptions,b.movieStarOptions),b.filePatterns.flash9=RegExp("\\.(mp3|"+Ia.join("|")+")(\\?.*)?$","i"),b.features.movieStar=!0):b.features.movieStar=!1;b.filePattern=b.filePatterns[8!==M?"flash9":"flash8"];b.movieURL=(8===M?"soundmanager2.swf":"soundmanager2_flash9.swf").replace(".swf",a);b.features.peakData=b.features.waveformData=b.features.eqData=8<M};V=function(a,b){if(!s)return!1;s._setPolling(a,b)};P=function(){};U=this.getSoundById;Aa=function(){var a=
...
b[a]))};Y=function(){if(aa)return!1;if(b.html5Only)return aa||(ga.remove(a,"load",b.beginDelayedInit),b.enabled=!0,ha()),!0;va();try{s._externalInterfaceTest(!1),V(!0,b.flashPollingInterval||(b.useHighPerformance?10:50)),b.debugMode||s._disableDebug(),b.enabled=!0,b.html5Only||ga.add(a,"unload",J)}catch(d){return C({type:"JS_TO_FLASH_EXCEPTION",fatal:!0}),T(!0),ha(),!1}ha();ga.remove(a,"load",b.beginDelayedInit);return!0};u=function(){if(X)return!1;X=!0;xa();P();!Fa&&b.hasHTML5&&b.setup({useHTML5Audio:!0,
...
a(document).on("change","input.mute",function(){var g=a(this);if("all"==g.val())d.muteAll(g.is(":checked"));else{var h={};h[g.val()]=g.is(":checked");d.mute(h)}});a(document).on("change","input.unmute",function(){var g=a(this);if("all"===g.val())d.muteAll(!g.is(":checked"));else{var h={};h[g.val()]=!g.is(":checked");d.mute(h)}})});return d}(jQuery);vorple.notify=function(a){var d={defaults:{layout:"bottomRight",timeout:7E3},alert:function(k,h){var m=a.extend({},{buttons:[{text:"OK",onClick:function(a){a.close()}}],layout:"center",modal:!0,timeout:!1},h);d.show(k,m)},clearQueue:function(){a.noty.clearQueue()},close:function(){a.noty.close(this._currentNoty)},closeAll:function(){a.noty.closeAll()},show:function(k,h){var m=a.extend({},d.defaults,h,{text:k});noty(m)}};return d}(jQuery);vorple.parser=function(a){var d={},k=[],h=null,m="#parchment .main",q=[],g=[],p={},r=!1,b=null,t=!1,s=[],w={commandVisible:!0,mode:"line",outputVisible:!0,type:"normal"},E=!1,z=function(b){return a("<span>"+b+"</span>").addClass("vorplePrompt").append('<input type="text" />')},y=function(){a.each(g,function(a,b){try{b()}catch(d){console&&console.log&&console.log("Invalid JavaScript: "+b)}});g=[]},J=function(b,d){var g={};console.log(d.html());var h=d.clone();a("input",h).hide();if("line"===b){g.previousCommand=
h.text().split("\n")[0];h.html(h.html().replace(/(<span>)?.*\n/,"$1"));var k=a("span:last",h);a("input",k).appendTo(h);var m=k.html().split("\n");1<m.length?(g.prompt=m.pop(),k.html(m.join("\n")+"\n")):(g.prompt=k.html(),k.remove())}else g.prompt="";g.$turn=h;return g},xa=function(b,d){if(!b)return!1;switch(d.turn.type){case "error":b.classes+="parserError ";b.previousCommand.classes+="parserError ";b.content.classes+="transient ";b.meta=!0;break;case "undo":case "meta":return""!==a.trim(a(b.content.text).text())&&
vorple.notify.show(b.content.text),!1;case "dialog":return""!==a.trim(a(b.content.text).text())&&vorple.notify.show(b.content.text,{buttons:[{type:"button",text:"ok",click:function(a){a.close()}}],closeButton:!0,layout:"center",modal:!0,timeout:!1}),!1}return b},Y=function(){if(0===k.length&&0===s.length)return!1;var g;0<s.length?(g=s,null===b&&(b=a.extend({},w))):(g=k,null!==b&&(w=a.extend({},b),b=null));var h=g[0],m=a.extend({hideCommand:!1,hideOutput:!1,skipFilters:!1},h.options),p=a("input.TextInput"),
q=p.val();g.shift();m.hideOutput&&d.hideOutput();m.hideCommand&&(d.hideCommand(),a(document).one("TurnComplete",function(){a(".TextInput").val(q)}));m.skipFilters&&(t=!0);r=!1;p.val(h.command).trigger(a.Event("keydown",{which:13}));t=!1;return!0},M=function(b,d,g){if(t)return b;var h=a.extend({},p),k=0,m;for(m in h)h.hasOwnProperty(m)&&k++;for(m=0;m<k;++m){var q=null;a.each(h,function(a,b){b.type===d&&(null===q||q.priority<b.priority)&&(q=b)});q&&(b=q.filter(b,g),delete h[q.name])}return b};d.closeAllTags=
function(){q=[];m="#parchment .main"};d.closeTag=function(){0!==q.length&&(q.pop(),m=0===q.length?"#parchment .main":q[q.length-1])};d.getStream=function(){return m};d.hideCommand=function(a){"undefined"===typeof a&&(a=!0);w.commandVisible=!a};d.hideOutput=function(a){"undefined"===typeof a&&(a=!0);w.outputVisible=!a};d.isVorpleStory=function(){return E};d.openTag=function(b,d){var g=vorple.core.generateId();a(vorple.html.tag(b,"",{classes:d,id:g})).appendTo(m);q.push("#"+g);m="#"+g};d.queueExpression=
function(a){g.push(a)};d.registerFilter=function(b,d){var g=a.extend({priority:0,name:"filter_"+vorple.core.generateId(),type:"output"},d);p[g.name]={filter:b,name:g.name,priority:g.priority,type:g.type};return p[g.name]};d.scrollTo=function(b,d,g){var h=a(document).height()-a(window).height();d="undefined"===typeof d?150:d;switch(b){case "bottom":b=h;break;case "top":b=0;break;default:b="number"===typeof b?b:a(b).offset().top}b>h&&(b=h);var k=!1;a("html, body").animate({scrollTop:b},d,function(){k||
"function"!==typeof g||(g(),k=!0)})};d.sendCommand=function(a,b){(b&&b.primaryCommand?s:k).push({command:a,options:b});r&&Y()};d.sendPrimaryCommand=function(b,g){d.sendCommand(b,a.extend({},g,{primaryCommand:!0}))};d.sendSilentCommand=function(a){d.sendCommand(a,{hideCommand:!0,hideOutput:!0,skipFilters:!0,primaryCommand:!1})};d.sendSilentPrimaryCommand=function(a){d.sendCommand(a,{hideCommand:!0,hideOutput:!0,skipFilters:!0,primaryCommand:!0})};d.setTurnType=function(a){w.type=a};d.setVorpleStory=
function(){E=!0};d.unregisterFilter=function(a){delete p[a]};a(document).on("init.vorple",function(){if(vorple.core.engine("parchment")){0===a("#vorpleContainer").length&&a('<div id="vorpleContainer"></div>').appendTo("body");var b=a("#vorpleContainer");0===a("#vorple").length&&b.append('<div id="vorple"></div>');0===a("#vorpleInput").length&&b.append('<div id="vorpleInput"></div>');0===a("#vorple-media").length&&b.append('<div id="vorple-media"></div>');0===a("#parchment").length&&a("body").append('<div id="parchment"></div>');
h=vorple.core.getEngine().options.container;d.registerFilter(xa,{type:"output",name:"meta-turn filters"});a(document).on("click.vorple","a.commandLink",function(b){b.preventDefault();b=a(this).attr("href");var g={hideCommand:a(this).hasClass("hideCommand"),hideOutput:a(this).hasClass("hideResponse")};d.sendCommand(b,g)});a(document).on("keydown.vorple",".vorplePrompt input",function(b){if(13===b.which)return b.preventDefault(),b=M(a(this).val(),"input"),d.sendCommand(b),!1});a(document).off(".TextInput");
a(document).on("click.vorple keydown.vorple",function(b){var g=a(".vorplePrompt input");if(g.length&&"INPUT"!==b.target.nodeName&&"A"!==b.target.nodeName&&(window.getSelection()||""===(document.selection?document.selection.createRange().text:""))){b.target=g[0];if("none"!==a("#vorpleContainer").attr("display")&&(0<a(window).scrollTop()-g.offset().top||60>a(window).scrollTop()+a(window).height()-g.offset().top))d.scrollTo(g,100,function(){g.focus().trigger(b)}),b.stopPropagation();else{if("keydown"===
b.type&&8===b.which)return!1;g.focus().trigger(b)}"char"===w.mode&&a("input.TextInput").trigger(a.Event("keypress",{which:b.which}))}});a(document).on("TextInput.vorple",function(){a(".transient","#vorple").animate({opacity:0},1500).slideUp(500,function(){a(this).remove()});d.setTurnType("normal")});a(document).one("TurnComplete.vorple",function(){a("#vorpleLoader").slideUp();E&&d.sendCommand("__start_story",{hideCommand:!0,skipFilters:!0})});a(document).on("TurnComplete.vorple",function(b){var g=
a(".main",h),k=a("#vorple"),m=J(b.mode,g),p=M({previousCommand:{text:m.previousCommand,classes:""},content:{text:m.$turn.html(),classes:""},prompt:{text:m.prompt,val:"",classes:""},meta:!1,classes:"",mode:b.mode},"output",{turn:w});if("object"!==typeof p||!w.commandVisible&&!w.outputVisible)return a("input",g).appendTo("body").hide(),g.empty(),a(".vorplePrompt input").val(""),d.hideCommand(!1),d.hideOutput(!1),y(),w.mode=b.mode,r=!0,Y(),!1;if("char"===b.mode&&a(".turn").length)a("<span></span>").html(p.content.text).appendTo(a("#vorple .main:last")),
a(".vorplePrompt:last",k).remove(),a(z(p.prompt.text)).addClass(p.prompt.classes).appendTo(t).find("input").val(s),a("input",g).appendTo("body").hide(),g.empty(),w.mode=b.mode,r=!0;else{var q;w.outputVisible&&(m.$turn.html(p.content.text).addClass(p.content.classes),q=a("<div></div>").append(m.$turn));var s=p.prompt.val;w.commandVisible?a(".vorplePrompt input",k).replaceWith(a("<span></span>").addClass("previousCommand").addClass(p.previousCommand.classes).html(p.previousCommand.text)):(s=a(".vorplePrompt input",
k).val(),a(".vorplePrompt:last",k).remove());q&&q.addClass("turnContent").addClass(p.turnClasses);var t=a("<div></div>").addClass("turn").addClass(p.classes).append(q),m=q.find(".main input:last").prev();"SPAN"===m.prop("tagName")&&"\n\n\n"===q.text().substr(q.text().length-3)&&m.remove();p.meta||"line"!==b.mode||(a(".penultimateTurn").removeClass("penultimateTurn"),a(".previousTurn").addClass("penultimateTurn").removeClass("previousTurn").addClass("previousTurnFader").removeClass("previousTurnFader",
1E3),t.addClass("previousTurn"));var D=a(z(p.prompt.text)).addClass(p.prompt.classes).appendTo(t).find("input").val(s);t.appendTo(k);y();a("input",g).appendTo("body").hide();g.empty();"char"===b.mode&&a("<span>\n</span>").appendTo(g);d.hideCommand(!1);d.hideOutput(!1);d.scrollTo(q,void 0,function(){var b=a(window).scrollTop(),d=b+a(window).height(),g=D.offset().top;g+D.height()<=d&&g>=b&&D.focus();D.addClass("hilightNoFocus")});w.mode=b.mode;r=!0;Y()}})}});return d}(jQuery);vorple.tooltip=function(a){var d={defaults:{show:{event:"mouseenter",ready:!1},content:{attr:"title"},position:{my:"bottom left",at:"top center"},overwrite:!1,delay:3E3,duration:1E4}},k=function(h,k){var q=a.extend({},d.defaults,k),g=a(h);!q.content&&g.attr(q.content.attr);q.content&&g.qtip(q);return g};d.enable=function(h,m){var q=a.extend(!0,{},d.defaults,{show:{ready:!0,event:d.defaults.show.event}},m);return a(document).on(q.show.event,h,function(){k(this,q)})};d.show=function(h,m,q){"undefined"===
